...
export function AddDocumentMenu({ className }: Props) {
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <h2 id="add-document-title" className="text-sm font-semibold text-foreground">
              Lägg till dokument
            </h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Dokument laddas upp från kundsidor. Välj om du vill skapa en ny kund eller lägga till på en befintlig kund.
            </p>
