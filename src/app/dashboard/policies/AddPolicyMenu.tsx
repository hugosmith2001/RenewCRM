...
export function AddPolicyMenu({ className }: Props) {
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <h2 id="add-policy-title" className="text-sm font-semibold text-foreground">
              Lägg till försäkring
            </h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Välj om du vill skapa en ny kund eller lägga till på en befintlig kund.
            </p>
