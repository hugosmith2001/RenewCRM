...
export function AddTaskMenu({ className }: Props) {
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <h2 id="add-task-title" className="text-sm font-semibold text-foreground">
              Lägg till att göra
            </h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Att göra skapas på kundsidor. Välj om du vill skapa en ny kund eller lägga till på en befintlig kund.
            </p>
